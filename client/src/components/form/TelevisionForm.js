...
const TelevisionFrom = ({
    ...
    }, [watch("name"), watch("price"), watch("stock"), watch("inch")]);
                        ...
                        <div className="flex flex-col justify-center items-start space-y-4 w-full">
                            {attributes &&
                                attributes.map((el, index) => (
                                    ...
                                    >
                                        <input
                                            checked={checkAttributes.inch}
                                            onClick={() =>
                                                setAttributesCheck((prev) => ({
                                                    ...prev,
                                                    inch: !checkAttributes.inch,
                                                }))
                                            }
                                            id="checkbox-default"
                                            type="checkbox"
                                            ...
                                            {checkAttributes.inch && (
                                                <div className="w-[300px]">
                                                    <InputForm
                                                        ...
                                                        style="flex-auto"
                                                        placeholder="inch of new product"
                                                    />
                                                </div>
                                            )}
                                        </label>
